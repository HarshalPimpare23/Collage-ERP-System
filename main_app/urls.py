...
urlpatterns = [
     ...
     # --------------------------------------------------------------------------------
     path("fetch_application_report/", hod_views.fetch_application_report, name='fetch_application_report'),
     path("student_admission_report/", hod_views.student_admission_report, name='student_admission_report'),
     path("confirm_application_report/", hod_views.confirm_application_report, name='confirm_application_report'),
     path("student_registration_report/", hod_views.student_registration_report, name='student_registration_report'),
     path("student_general_report/", hod_views.student_general_report, name='student_general_report'),
     path("student_address_report/", hod_views.student_address_report, name='student_address_report'),
     path("cancelled_admission_report/", hod_views.cancelled_admission_report, name='cancelled_admission_report'),
     #  ---------------------------------------------------------------------------------
     path("fees_and_payment_report/", hod_views.fees_and_payment_report, name='fees_and_payment_report'),
     path("vidyapeeth_fees_collection_report/", hod_views.vidyapeeth_fees_collection_report, name='vidyapeeth_fees_collection_report'),
     path("vidyapeeth_fees_peinding_report/", hod_views.vidyapeeth_fees_peinding_report, name='vidyapeeth_fees_peinding_report'),
     path("others_fees_collection_report/", hod_views.others_fees_collection_report, name='others_fees_collection_report'),

     #  ----------------------------------------------------------------------------------
     path("create_timetable/", hod_views.create_timetable, name='create_timetable'),
     path("view_timetable/", hod_views.view_timetable, name='view_timetable'),
